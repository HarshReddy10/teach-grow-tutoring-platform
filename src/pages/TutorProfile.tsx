      ...
      <div className="container py-8">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex flex-col gap-6 sm:flex-row">
              ...
              <div className="flex-1">
                <div className="mb-2 flex flex-wrap items-center gap-2">
                  ...
                  <Badge variant="secondary">{tutor.mode?.toLowerCase() === "both" ? "Online, Offline" : tutor.mode}</Badge>
                ...
                <div className="flex flex-wrap items-center gap-3 mb-1">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button variant="outline" size="sm" className="h-8 gap-1.5 rounded-lg border-border/60 hover:bg-secondary text-xs px-2.5">
                    ...
                    <PopoverContent className="w-56 p-2 rounded-xl" align="start">
                      <div className="grid gap-1">
                        <a
                          ...
                          className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm hover:bg-secondary transition-colors text-foreground"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm hover:bg-secondary transition-colors text-foreground text-left w-full"
                        >
                          <svg className="h-4 w-4 fill-[#E1306C]" viewBox="0 0 24 24">
                        ...
                        {navigator.share && (
                          <button
                            ...
                            className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm hover:bg-secondary transition-colors text-foreground text-left w-full border-t mt-1 pt-2"
                          >
            ...
            {tutor.workExperience && tutor.workExperience.length > 0 && (
              <Card className="border-border/60 shadow-sm relative overflow-hidden">
                ...
                <CardContent className="pt-6 relative">
                  {(() => {
                    ...
                    const experiences = tutor.workExperience;
